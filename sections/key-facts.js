/* =====================================================================
   ...
   optional "In detail" affordance rather than a wall of bullets, while
   the full standalone sentences stay present in the DOM (collapsed
   content still renders, so a crawler or quoting model still gets them
   verbatim) for the machine-readable layer.
   ===================================================================== */
